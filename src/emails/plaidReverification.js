...
const sendPlaidReverificationEmail = (email, name) => {
  sgMail.send({
    to: email,
    from: "amitdgpghosh@gmail.com",
    subject: name + ", your bank account needs to be reverified on Everchange",
  ...
  <tbody>
    <tr>
      <td style="padding:50px 30px 18px 30px; line-height:36px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="font-size: 43px">Reverification of Bank Account&nbsp;</span></div><div></div></div></td>
    </tr>
  </tbody>
  </table><table class="module" role="module" data-type="text" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;" data-muid="a10dcb57-ad22-4f4d-b765-1d427dfddb4e" data-mc-module-version="2019-10-22">
  <tbody>
    <tr>
      <td style="padding:18px 30px 18px 30px; line-height:22px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="font-size: 18px">Your bank account needs to be reverified to continue using EverChange. Please login to EverChange and reverify bank account.</span><span style="font-size: 18px"></span></div>
...
module.exports = sendPlaidReverificationEmail;
